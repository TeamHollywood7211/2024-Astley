...
public class IntakeShooterCommandForAmp extends Command {
  ...
  public IntakeShooterCommandForAmp(IntakeSubsystem intakeSubsystem, ShooterSubsystem shooterSubsystem, LEDSubsystem ledSubsystem, CommandXboxController controller) {
  ...
  public void execute() {
   ...
   if(m_controller.rightTrigger().getAsBoolean()) //On standard shoot  RIGHT TRIGGER
   {
      m_shooterSubsystem.setShooterSpeed(RobotContainer.shooterSpeed);
