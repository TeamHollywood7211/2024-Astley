...
public class Auto_intake_unsafe extends Command {
  ...
  int timesRan = 1;
  double timer = 0;
  double timeToKill = 1; //Time until to give up on the intake
  double spd;
  double intakeSpd;
  //Timer time;
 // double timer = 0;

  public Auto_intake_unsafe(IntakeSubsystem subsystem, LEDSubsystem led, ShooterSubsystem shooter, double speed, double intake_spd) {
    m_intake = subsystem;
    m_led = led;
    m_shooter = shooter;
    spd = speed;
    intakeSpd = intake_spd;
